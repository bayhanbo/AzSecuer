...
public class SpeedupAdapter extends BaseAdapter implements OnClickListener,OnCheckedChangeListener {

	private List<SpeedupInfo> dataList = new ArrayList<>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView tv_speedup_lable = (TextView) view.findViewById(R.id.tv_speedup_info);
		TextView tv_speedup_memory = (TextView) view.findViewById(R.id.tv_speedup_ram);
